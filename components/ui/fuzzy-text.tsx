...
>(({
  ...
  const innerRef = useRef<(HTMLCanvasElement & { cleanupFuzzyText?: () => void }) | null>(null)
  ...
  const getComputedColor = React.useCallback(() => {
  ...
  useEffect(() => {
    ...
    if ((canvas as HTMLCanvasElement & { cleanupFuzzyText?: () => void }).cleanupFuzzyText) {
